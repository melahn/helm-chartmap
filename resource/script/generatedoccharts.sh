...
java -jar $jarfile -c "$chart:3.0.8" -o $outdir/"$chart-3.0.8.puml" -g
# Alfresco DBP
chart=alfresco-dbp
outdir=$docdir/$chart
java -jar $jarfile -c "$chart:1.5.0" -o $outdir/"$chart-1.5.0.txt"  
java -jar $jarfile -c "$chart:1.5.0" -o $outdir/"$chart-1.5.0.json" 
java -jar $jarfile -c "$chart:1.5.0" -o $outdir/"$chart-1.5.0.puml" -g
# Identity Service
...
java -jar $jarfile -c "$chart:0.2.0" -o "$outdir/$chart-0.2.0.puml" -g
java -jar $jarfile -c "$chart:0.3.0" -o "$outdir/$chart-0.3.0.txt"  
java -jar $jarfile -c "$chart:0.3.0" -o "$outdir/$chart-0.3.0.json" 
java -jar $jarfile -c "$chart:0.3.0" -o "$outdir/$chart-0.3.0.puml" -g
# Wordpress
chart=wordpress
outdir=$docdir/$chart
...
java -jar $jarfile -c "$chart:13.1.4"  -o "$outdir/$chart-13.1.4.puml"  -g
